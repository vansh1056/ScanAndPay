...
const HomePage: React.FC = () => {
  ...
  const handlePaymentAndPrint = async () => {
    ...
    // Step 2: Upload file + printer details to backend
    ...
    // Send printer IP (scanned or manual) + printer name
    formData.append("printer_ip", scannedIP);
    formData.append("printer_name", "HP LaserJet Pro MFP M126nw[47F853]");
